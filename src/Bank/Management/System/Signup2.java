...
Signup2(String formno) {
    ...
    String religion[] = {"Hindu", "Muslim", "Sikh", "CXhirstian", "Other"};
    ...
    String occupation[] = {"Salaried", "Self-Employed", "Student", "Buisness", "Retired", "Other"};
    ...
    JLabel l11 = new JLabel("Existong Account :");
